...
<html>
    ...
    <body>
        ...
        <?php
                ...
                if($_POST['user_id']=="aj38@gmail.com" && $_POST['password']=="123456"){
        ...
        <div class="container">
            ...
            <form class="pure-form pure-form-stacked" method="post">
                <fieldset>
                    ...
                    <input type="text" id="user_id" name="user_id" class="pure-input-1-2" value="aj38@gmail.com">
 
                    <label for="message1">Password</label>
                    <input type="Password" id="Password" name="password" class="pure-input-1-2" value="123456">
